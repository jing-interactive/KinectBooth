...
@Parameter(min = -1, max = 1) float _CFG_H0 = 0;
@Parameter(min = -1, max = 1) float _CFG_S0 = 0;
@Parameter(min = -1, max = 1) float _CFG_H1 = 0;
@Parameter(min = -1, max = 1) float _CFG_S1 = -0.29;
@Parameter(min = -1, max = 1) float _CFG_H2 = 0;
@Parameter(min = -1, max = 1) float _CFG_S2 = -0.43;
@Parameter(min = -1, max = 1) float _CFG_H3 = 0;
@Parameter(min = -1, max = 1) float _CFG_S3 = 0;
